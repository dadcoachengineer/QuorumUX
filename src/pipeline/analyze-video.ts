/**
 * Quorum Pipeline Stage 2b: Video Analysis
 *
...
import { QuorumConfig, VideoAnalysis } from '../types';
 ...
 */
function buildVideoUserMessage(config: QuorumConfig, videoFile: string, summaryContext: string): string {
  const parts = [
...
function formatVideoAnalysesForMarkdown(
  ...
  parts.push(`---`, `*Generated by Quorum UX Analysis Pipeline*`);
